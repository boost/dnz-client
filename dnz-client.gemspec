...
Gem::Specification.new do |s|
  ...
  s.files = ["History.txt", "Manifest.txt", "PostInstall.txt", "README.rdoc", "License.txt", "Rakefile", "lib/dnz.rb", "lib/dnz/attributes.rb", "lib/dnz/client.rb", "lib/dnz/facet.rb", "lib/dnz/facet_array.rb", "lib/dnz/result.rb", "lib/dnz/search.rb", "lib/dnz/error/invalid_api_key.rb", "script/console", "script/destroy", "script/generate", "spec/dnz/client_spec.rb", "spec/dnz/result_spec.rb", "spec/dnz/search_spec.rb", "spec/spec.opts", "spec/spec_helper.rb", "tasks/rspec.rake"]
